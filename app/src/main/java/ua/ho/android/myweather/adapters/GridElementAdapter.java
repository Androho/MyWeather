...
public class GridElementAdapter extends RecyclerView.Adapter<GridElementAdapter.SimpleViewHolder>{
   ...
   // public static Observable<Forecast10day> forecast10dayObservable=null;
    ...
    public void onBindViewHolder(SimpleViewHolder holder, int position) {
        ...
        icName = forecast10day.getForecast()
                .getSimpleforecast().getForecastday().get(position).getIcon();
        int resId =context.getResources().getIdentifier(icName, "drawable", context.getPackageName());
